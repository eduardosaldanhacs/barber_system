<?php
	...
	$query = "SELECT * FROM $tabela WHERE id != 0 AND categoria = '$turma' $filtro ORDER BY categoria";
...
<div class="col-12 form-group">
	...
	<ul class="list-group color_font_black">
		...
		<li class="list-group-item active">Lista de Turmas</li>
		...
		while ($dados=mysqli_fetch_array($query)) { ?>	
			...
			<li class="list-group-item" id="<?=$dados['id']?>">
				...
				<div class="row">
					<div class="col-12 col-xl-3">
						<img src="../images/estruturas/<?=$dados['categoria']?>/<?= $dados['imagem'] ?>" alt="" class="zoomable-image" style="width: 150px; height: auto;">
					...
					<div class="col-12 col-xl-2 d-flex align-items-center">
						<?= formatarCategoria($dados['categoria']) ?>
					</div>

					<div class="col-12 col-xl-2 d-flex align-items-center">
						<?= $dados['principal'] == 'S' ? 'Sim' : 'Não' ?>
					</div>
