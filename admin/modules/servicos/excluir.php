...
<form method="post" action="<?=$action?>" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-6 form-group">
			<label for="imagem_atual">Capa Atual:</label><br>
            <img src="../images/banners/<?=$dados['imagem']?>" alt="" style="height: auto; width:100%">
		</div>
...
if($_GET['excluir'] == 'S') {
    ...
    $status = 'E';
    $id = $_GET['id'];
    $sql = "UPDATE capa SET status = '$status' WHERE id = '$id'";
