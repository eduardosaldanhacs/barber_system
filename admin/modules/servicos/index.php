...
<section id="agendamento" class="py-20 text-center bg-cover bg-center px-4">
    <form action="<?= SITE ?>admin/agendamento/cadastrar.php" class="max-w-lg mx-auto bg-gray-800 p-4 md:p-8 rounded-2xl shadow-lg">
        ...
        <input type="tel" name="phone" placeholder="Telefone" class="w-full p-3 mb-4 rounded bg-gray-700 text-white focus:outline-none">
